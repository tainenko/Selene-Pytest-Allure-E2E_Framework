...
class MainPage(BasePage):
    def __init__(self):
        ...
        self.searchbar = s("input#txtSearchKeyword") #搜尋輸入欄
        self.searchBtn = s("button.n-btn.n-btn--search") #搜尋按鈕
        self.search24Btn = s("button.n-btn.n-btn--search24") #搜24H按鈕
    ...
    def click_search24_button(self):
        self.search24Btn.click()
        return SearchResultPage()
